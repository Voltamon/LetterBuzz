...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" ref={sectionRef} className="overflow-hidden bg-gradient-to-br from-[hsl(42,88%,63%)]/5 via-background to-background relative !w-[99.9%] !h-[1100px] !text-base !py-0">
